...
export class trackHand extends ObjectNamedFunction1 {
  static type() {
    return "trackHand";
  }
...
export class trackHandGetNormalizedLandmarks extends ObjectNamedFunction2 {
  static type() {
...
export class trackHandGetWorldLandmarks extends ObjectNamedFunction2 {
  static type() {
...
export class getTrackedHandThumbDirection extends NamedFunction2 {
  static type() {
...
export class getTrackedHandIndexDirection extends NamedFunction2 {
  static type() {
    return "getTrackedHandIndexDirection";
  }
  func(values, target) {
    tmpV4.copy(values[CoreComputerVisionHandIndex.INDEX_FINGER_TIP]).sub(values[CoreComputerVisionHandIndex.INDEX_FINGER_DIP]);
    target.set(tmpV4.x, tmpV4.y, tmpV4.z).normalize();
    return target;
  }
}
export class getTrackedHandMiddleDirection extends NamedFunction2 {
  static type() {
    return "getTrackedHandMiddleDirection";
  }
  func(values, target) {
    tmpV4.copy(values[CoreComputerVisionHandIndex.MIDDLE_FINGER_TIP]).sub(values[CoreComputerVisionHandIndex.MIDDLE_FINGER_DIP]);
    target.set(tmpV4.x, tmpV4.y, tmpV4.z).normalize();
    return target;
  }
}
export class getTrackedHandRingDirection extends NamedFunction2 {
  static type() {
    return "getTrackedHandRingDirection";
  }
  func(values, target) {
    tmpV4.copy(values[CoreComputerVisionHandIndex.RING_FINGER_TIP]).sub(values[CoreComputerVisionHandIndex.RING_FINGER_DIP]);
    target.set(tmpV4.x, tmpV4.y, tmpV4.z).normalize();
    return target;
  }
}
export class getTrackedHandPinkyDirection extends NamedFunction2 {
  static type() {
