...
declare class SDF2DBoxJsParamsConfig extends NodeParamsConfig {
    ...
    sizes: import("../utils/params/ParamsConfig").ParamTemplate<import("../../index_all").ParamType.VECTOR2>;
}
export declare class SDF2DBoxJsNode extends BaseSDF2DJsNode<SDF2DBoxJsParamsConfig> {
