...
export class SetGeometryInstanceAttributeJsNode extends TypedJsNode {
  constructor() {
    super(...arguments);
  ...
  _expectedInputTypes() {
    ...
    const type = firstInputType && ALLOWED_TYPES.includes(firstInputType) ? firstInputType : JsConnectionPointType.FLOAT_ARRAY;
