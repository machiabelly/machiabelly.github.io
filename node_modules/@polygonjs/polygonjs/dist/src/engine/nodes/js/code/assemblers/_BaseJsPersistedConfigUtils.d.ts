...
export declare function createVariable(type: JsConnectionPointType): Vector2 | Vector3 | Vector4 | Color | Euler | Quaternion | Matrix4 | Box3 | Plane | Sphere | Ray | PrimitiveArray<PrimitiveArrayElement> | VectorArray<VectorArrayElement> | null;
