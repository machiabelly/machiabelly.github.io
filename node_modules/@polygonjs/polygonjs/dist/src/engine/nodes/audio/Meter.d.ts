...
declare class MeterAudioParamsConfig extends NodeParamsConfig {
    ...
    updateValueParam: import("../utils/params/ParamsConfig").ParamTemplate<import("../../index_all").ParamType.BOOLEAN>;
    /** @param meter value */
    value: import("../utils/params/ParamsConfig").ParamTemplate<import("../../index_all").ParamType.FLOAT>;
    /** @param display meter param */
...
export declare class MeterAudioNode extends BaseAnalyserAudioNode<MeterAudioParamsConfig> {
