...
export declare function ObjCADTesselationFolderParamConfig<TBase extends Constructor>(Base: TBase): {
    new (...args: any[]): {
        CAD: import("../../utils/params/ParamsConfig").ParamTemplate<import("../../../index_all").ParamType.FOLDER>;
    };
} & TBase;
export declare function ObjCSGTesselationFolderParamConfig<TBase extends Constructor>(Base: TBase): {
    new (...args: any[]): {
        CSG: import("../../utils/params/ParamsConfig").ParamTemplate<import("../../../index_all").ParamType.FOLDER>;
    };
} & TBase;
export declare function ObjQUADTesselationFolderParamConfig<TBase extends Constructor>(Base: TBase): {
    new (...args: any[]): {
        QUAD: import("../../utils/params/ParamsConfig").ParamTemplate<import("../../../index_all").ParamType.FOLDER>;
    };
} & TBase;
export declare function ObjTetTesselationFolderParamConfig<TBase extends Constructor>(Base: TBase): {
    new (...args: any[]): {
        TET: import("../../utils/params/ParamsConfig").ParamTemplate<import("../../../index_all").ParamType.FOLDER>;
    };
} & TBase;
export declare function ObjTesselationParamConfig<TBase extends Constructor>(Base: TBase): {
    new (...args: any[]): {
        ...
        QUADUnsharedEdges: import("../../utils/params/ParamsConfig").ParamTemplate<import("../../../index_all").ParamType.BOOLEAN>;
...
export declare class TesselationParamsObjNode extends TypedObjNode<Object3D, TesselationParamParamsConfig> {
}
export {};
