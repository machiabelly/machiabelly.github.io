 ...
 */
declare const ImageEXRCopNode_base: typeof import("./utils/image/_BaseImage").copImageNodeFactoryFactoryResult;
export declare class ImageEXRCopNode extends ImageEXRCopNode_base {
}
export {};
