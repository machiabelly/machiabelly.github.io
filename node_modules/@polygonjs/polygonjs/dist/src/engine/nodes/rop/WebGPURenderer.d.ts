...
declare class WebGPURendererRopParamsConfig extends NodeParamsConfig {
...
export declare class WebGPURendererRopNode extends TypedRopNode<WebGPURendererRopParamsConfig> {
    paramsConfig: WebGPURendererRopParamsConfig;
    static type(): Readonly<RopType.WEBGPU>;
    ...
    static PARAM_CALLBACK_updateToneMapping(node: WebGPURendererRopNode): void;
    static PARAM_CALLBACK_updateToneMappingExposure(node: WebGPURendererRopNode): void;
    static PARAM_CALLBACK_updateOutputColorSpace(node: WebGPURendererRopNode): void;
    static PARAM_CALLBACK_updateShadow(node: WebGPURendererRopNode): void;
    static PARAM_CALLBACK_updateSortObjects(node: WebGPURendererRopNode): void;
    static PARAM_CALLBACK_updatePixelRatio(node: WebGPURendererRopNode): void;
