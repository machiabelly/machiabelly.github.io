...
import { TextureSpecularMapControllers } from './utils/TextureSpecularMapController';
...
export declare class MeshPhongBuilderMatNode extends TypedBuilderMatNode<MeshPhongBuilderMaterial, ShaderAssemblerPhong, MeshPhongBuilderMatParamsConfig> {
    paramsConfig: MeshPhongBuilderMatParamsConfig;
    static type(): MatType;
    usedAssembler(): Readonly<AssemblerName.GL_MESH_PHONG>;
    protected _createAssemblerController(): import("../gl/code/Controller").GlAssemblerController<ShaderAssemblerPhong> | undefined;
