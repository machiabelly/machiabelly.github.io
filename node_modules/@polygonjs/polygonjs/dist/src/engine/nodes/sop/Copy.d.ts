...
export declare class CopySopNode extends TypedSopNode<CopySopParamsConfig> {
    ...
    stampValue(attribName?: string): string | number | boolean | import("../../index_all").Number3 | import("../../index_all").Number2 | import("../../../types/GlobalTypes").Vector2Like | import("../../../types/GlobalTypes").ColorLike | import("../../index_all").Number4 | undefined;
