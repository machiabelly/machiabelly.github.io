...
export declare class PointExpression extends BaseMethod {
    ...
    _get_value_from_container(container: GeometryContainer, attrib_name: string, point_index: number): string | number | boolean | import("../../index_all").Number3 | import("../../index_all").Number2 | import("../../../types/GlobalTypes").Vector2Like | import("../../../types/GlobalTypes").ColorLike | import("../../index_all").Number4 | null;
}
