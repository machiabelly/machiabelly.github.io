...
export declare class ColorParam extends TypedMultipleParam<ParamType.COLOR> {
    ...
    _prefilterInvalidRawInput(rawInput: any): Color | StringOrNumber3;
    ...
    protected _cloneRawInput(raw_input: ParamInitValuesTypeMap[ParamType.COLOR]): Color | StringOrNumber3;
