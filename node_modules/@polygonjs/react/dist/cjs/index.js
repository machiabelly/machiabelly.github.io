...
var PolygonjsScene = /** @class */ (function (_super) {
    ...
    function PolygonjsScene(props) {
        ...
        _this._polygonjsContainer = (React__default["default"].createElement("div", { className: "polygonjs-scene", ref: _this.containerRef }));
        _this.state = {
            progress: 0,
        };
        return _this;
    ...
    PolygonjsScene.prototype._createBackgroundImage = function () {
        ...
        var poster = (React__default["default"].createElement("div", { className: ['polygonjs-scene-container-poster'].concat(this.posterClassObject()).join(' '), style: style }));
    ...
    PolygonjsScene.prototype.render = function () {
        var progressBar = (React__default["default"].createElement("div", { className: ['progress-bar'].concat(this.progressBarClassObject()).join(' ') },
            React__default["default"].createElement("div", { className: "progress-bar-bar", style: this.progressBarBarStyleObject() })));
        var progressBarIfRequired = this.props.displayLoadingProgressBar ? progressBar : null;
        return (React__default["default"].createElement("div", { className: "polygonjs-scene-container" },
...
exports.PolygonjsScene = PolygonjsScene;
