...
export var TrackHandJsNodeOutput = /* @__PURE__ */ ((TrackHandJsNodeOutput2) => {
  TrackHandJsNodeOutput2["NORMALIZED_LANDMARKS"] = "normalizedLandmarks";
  TrackHandJsNodeOutput2["WORLD_LANDMARKS"] = "worldLandmarks";
  return TrackHandJsNodeOutput2;
})(TrackHandJsNodeOutput || {});
class TrackHandJsParamsConfig extends NodeParamsConfig {
  constructor() {
    super(...arguments);
    this.handIndex = ParamConfig.INTEGER(0, {
      range: [0, 1],
...
export class TrackHandJsNode extends TypedJsNode {
  constructor() {
    super(...arguments);
  ...
  initializeNode() {
    ...
    this.io.outputs.setNamedOutputConnectionPoints([
      new JsConnectionPoint("normalizedLandmarks" /* NORMALIZED_LANDMARKS */, JsConnectionPointType.VECTOR4_ARRAY),
      new JsConnectionPoint("worldLandmarks" /* WORLD_LANDMARKS */, JsConnectionPointType.VECTOR4_ARRAY)
    ]);
  }
  ...
  setLines(shadersCollectionController) {
    ...
    _v4(
      "normalizedLandmarks" /* NORMALIZED_LANDMARKS */,
      "trackHandGetNormalizedLandmarks",
      JsConnectionPointType.VECTOR4_ARRAY
    );
    _v4("worldLandmarks" /* WORLD_LANDMARKS */, "trackHandGetWorldLandmarks", JsConnectionPointType.VECTOR4_ARRAY);
  }
}
