...
export declare class ViewerRaycastersController {
    ...
    raycaster0(): {
        ...
        camera: {
            ...
            copy: (source: import("three").Camera, recursive?: boolean | undefined) => import("three").Camera;
            addEventListener: {
        ...
        setFromCamera: (coords: import("three").Vector2, camera: import("three").Camera) => void;
