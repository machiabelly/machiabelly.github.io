...
import { ExtendableOnObjectPointerEventJsNode, GPUOnObjectPointerEventJsParamsConfig } from './_BaseOnObjectPointerEvent';
import { JsLinesCollectionController } from './code/utils/JsLinesCollectionController';
declare const OnObjectClickGPUJsParamsConfig_base: {
    new (...args: any[]): {
    ...
    new (...args: any[]): {
        ...
        maxDuration: import("../utils/params/ParamsConfig").ParamTemplate<import("../../index_all").ParamType.INTEGER>;
    };
} & typeof GPUOnObjectPointerEventJsParamsConfig;
export declare class OnObjectClickGPUJsParamsConfig extends OnObjectClickGPUJsParamsConfig_base {
}
export declare class OnObjectClickGPUJsNode extends ExtendableOnObjectPointerEventJsNode<OnObjectClickGPUJsParamsConfig> {
    readonly paramsConfig: OnObjectClickGPUJsParamsConfig;
    static type(): JsType;
