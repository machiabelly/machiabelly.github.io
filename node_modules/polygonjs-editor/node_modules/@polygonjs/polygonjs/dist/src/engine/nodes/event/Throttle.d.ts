...
declare class ThrottleEventParamsConfig extends NodeParamsConfig {
    ...
    time: import("../utils/params/ParamsConfig").ParamTemplate<import("../../index_all").ParamType.INTEGER>;
...
export declare class ThrottleEventNode extends TypedEventNode<ThrottleEventParamsConfig> {
