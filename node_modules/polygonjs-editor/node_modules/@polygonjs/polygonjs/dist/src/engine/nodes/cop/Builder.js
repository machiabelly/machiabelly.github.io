...
export class BuilderCopNode extends TypedCopNode {
   ...
   */
  async renderTarget() {
    return this._renderTarget = this._renderTarget || await this._createRenderTarget(this.pv.resolution.x, this.pv.resolution.y);
  }
  ...
  async _createRenderTarget(width, height) {
    if (this._renderTarget) {
      const image = this._renderTarget.texture.image;
