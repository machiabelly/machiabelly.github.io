"use strict";
import { BufferGeometry, Float32BufferAttribute, Mesh, Vector2 } from "three";
...
export class FeatureConverter {
  ...
  createObject() {
    ...
    const perimeter = arraySum(coordinatesCollections.map((f) => f.perimeter()));
  ...
  _createLine(coordinatesCollection) {
