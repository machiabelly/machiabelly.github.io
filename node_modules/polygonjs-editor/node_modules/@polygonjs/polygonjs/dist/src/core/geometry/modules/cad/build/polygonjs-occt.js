...
var Module = (() => {
  ...
  return function(Module2) {
    ...
    var wasmBinaryFile;
    wasmBinaryFile = "polygonjs-occt.wasm";
    ...
    function createWasm() {
      ...
      function receiveInstance(instance, module) {
        ...
        wasmMemory = Module2["asm"]["qa"];
        updateGlobalBufferAndViews(wasmMemory.buffer);
        wasmTable = Module2["asm"]["xa"];
        addOnInit(Module2["asm"]["ra"]);
