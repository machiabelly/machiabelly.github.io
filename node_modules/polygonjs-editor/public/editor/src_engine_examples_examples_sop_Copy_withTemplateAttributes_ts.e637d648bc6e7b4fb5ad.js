(self["webpackChunk"] = self["webpackChunk"] || []).push([["src_engine_examples_examples_sop_Copy_withTemplateAttributes_ts"],{
  ...
  function create_geo1(parentNode) {
    ...
    function create_circle1(geo12) {
      ...
      circle1.uiData.setComment(
        "this circle node creates points that will then be used by the copy node below to define the position of the new objects. Try changing the arcAngle and segments to see how this changes the output of the copy node"
      );
    ...
    function create_normals2(geo12) {
      ...
      normals2.uiData.setComment(
        "this normal node sets the normals to [0,1,0] to all points. Try and replace the other normal node by this one to see how that changes the output of the copy node"
      );
    ...
    geo1_nodes["copy1"].node.setInput(0, geo1_nodes["subnet_arrow"].node);
    geo1_nodes["copy1"].node.setInput(1, geo1_nodes["attribCreate2"].node);
...
//# sourceMappingURL=src_engine_examples_examples_sop_Copy_withTemplateAttributes_ts.e637d648bc6e7b4fb5ad.js.map