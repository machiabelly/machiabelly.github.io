(self["webpackChunk"] = self["webpackChunk"] || []).push([["src_engine_examples_examples_mat_MeshBasicBuilder_blink_multiple_ts"],{
  ...
  function create_geo1(parentNode) {
    ...
    function create_MAT(geo12) {
      ...
      function create_meshBasicBuilder1(MAT3) {
        ...
        function create_attribute1(meshBasicBuilder15) {
          var attribute12 = meshBasicBuilder15.createNode("attribute");
          attribute12.setName("attribute1");
          attribute12.uiData.setPosition(-600, 450);
        ...
        function create_floatToVec2_1(meshBasicBuilder15) {
          var floatToVec2_12 = meshBasicBuilder15.createNode("floatToVec2");
          floatToVec2_12.setName("floatToVec2_1");
          floatToVec2_12.uiData.setPosition(-400, 450);
        ...
        function create_globals1(meshBasicBuilder15) {
          ...
          globals12.uiData.setPosition(-350, -100);
        ...
        function create_multAdd1(meshBasicBuilder15) {
          ...
          multAdd12.addParam(_polygonjs_polygonjs_src_engine_poly_ParamType__WEBPACK_IMPORTED_MODULE_0__/* .ParamType.FLOAT */ ._.FLOAT, "preAdd", 0, { spare: true, editable: false });
        ...
        function create_random1(meshBasicBuilder15) {
          var random12 = meshBasicBuilder15.createNode("random");
          random12.setName("random1");
          random12.uiData.setPosition(-300, 450);
          random12.params.postCreateSpareParams();
          random12.params.runOnSceneLoadHooks();
          return random12;
        }
        function create_round1(meshBasicBuilder15) {
          var round12 = meshBasicBuilder15.createNode("round");
          round12.setName("round1");
          round12.uiData.setPosition(-500, 450);
        ...
        var attribute1 = create_attribute1(meshBasicBuilder14);
        ...
        var floatToVec2_1 = create_floatToVec2_1(meshBasicBuilder14);
        ...
        var random1 = create_random1(meshBasicBuilder14);
        var round1 = create_round1(meshBasicBuilder14);
        var sin1 = create_sin1(meshBasicBuilder14);
        fit1.setInput("val", sin1, "val");
        floatToVec2_1.setInput("x", round1, "val");
        mix1.setInput("value0", constant1, "val");
        mix1.setInput("value1", constant2, "val");
        mix1.setInput("blend", fit1, "val");
        multAdd1.setInput("value", globals1, "time");
        multAdd1.setInput("preAdd", random1, "rand");
    ...
    function create_attribId1(geo12) {
      var attribId12 = geo12.createNode("attribId");
      attribId12.setName("attribId1");
      attribId12.uiData.setPosition(100, -50);
      attribId12.p.idn.set(false);
      attribId12.params.postCreateSpareParams();
      attribId12.params.runOnSceneLoadHooks();
      return attribId12;
    }
    function create_attribPromote1(geo12) {
      var attribPromote12 = geo12.createNode("attribPromote");
      attribPromote12.setName("attribPromote1");
      attribPromote12.uiData.setPosition(0, 250);
      attribPromote12.setAttribClassFrom(_polygonjs_polygonjs_src_core_geometry_Constant__WEBPACK_IMPORTED_MODULE_1__/* .AttribClass.OBJECT */ .io.OBJECT);
      attribPromote12.setAttribClassTo(_polygonjs_polygonjs_src_core_geometry_Constant__WEBPACK_IMPORTED_MODULE_1__/* .AttribClass.POINT */ .io.POINT);
      attribPromote12.p.name.set("id");
      attribPromote12.params.postCreateSpareParams();
      attribPromote12.params.runOnSceneLoadHooks();
      return attribPromote12;
    }
    function create_copy1(geo12) {
      var copy12 = geo12.createNode("copy");
      copy12.setName("copy1");
      copy12.uiData.setPosition(0, 100);
      copy12.p.copyAttributes.set(true);
      copy12.p.attributesToCopy.set("id");
    ...
    function create_material1(geo12) {
      ...
      material12.uiData.setPosition(0, 400);
    ...
    function create_plane1(geo12) {
      var plane12 = geo12.createNode("plane");
      plane12.setName("plane1");
      plane12.uiData.setPosition(100, -250);
      plane12.p.size.set([4, 4]);
    ...
    function create_sphere1(geo12) {
      ...
      sphere12.uiData.setPosition(-100, -50);
      sphere12.p.radius.set(0.36);
      sphere12.params.postCreateSpareParams();
      sphere12.params.runOnSceneLoadHooks();
      return sphere12;
    }
    var { MAT, meshBasicBuilder1: meshBasicBuilder12 } = create_MAT(geo1);
    var attribId1 = create_attribId1(geo1);
    var attribPromote1 = create_attribPromote1(geo1);
    var copy1 = create_copy1(geo1);
    var material1 = create_material1(geo1);
    var plane1 = create_plane1(geo1);
    var sphere1 = create_sphere1(geo1);
    attribId1.setInput(0, plane1);
    attribPromote1.setInput(0, copy1);
    copy1.setInput(0, sphere1);
    copy1.setInput(1, attribId1);
    material1.setInput(0, attribPromote1);
...
//# sourceMappingURL=src_engine_examples_examples_mat_MeshBasicBuilder_blink_multiple_ts.fe9c2183c1126d5f4e83.js.map