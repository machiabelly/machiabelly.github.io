(self["webpackChunk"] = self["webpackChunk"] || []).push([["src_engine_examples_examples_sop_Copy_stairCaseMultiple_ts"],{
...
function createData(options) {
  ...
  function create_geo1(parentNode) {
    ...
    function create_box2(geo12) {
      ...
      box2.uiData.setPosition(-100, -100);
    ...
    function create_copy1(geo12) {
      ...
      copy1.uiData.setComment(
        "Just like the copy node above, this node duplicates its input. It will therefore create multiple staircases.\n\nOn top of duplicating, it can also add variations to the copies, using the [copy](https://polygonjs.com/docs/expressions/copy) expression.\n\nIn this case, the copy is placed in the `count` parameter of the copy above, which is why each staircase has a different number of steps.\n\n**Try to** use that expression and use it to vary other parameters, like the sizes of the steps, or the rotation. **Anything** can be varied"
      );
      copy1.uiData.setPosition(-100, 900);
      copy1.flags.display.set(true);
      copy1.p.count.set(12);
      copy1.p.t.set([0, 0, -2.109588699886693]);
    ...
    geo1_nodes["copy1"].node.setInput(0, geo1_nodes["copy3"].node);
  ...
  function create_perspectiveCamera1(parentNode) {
    ...
    function create_events1(perspectiveCamera12) {
      ...
      function create_cameraOrbitControls1(events12) {
        ...
        cameraOrbitControls1.p.target.set([-8.35644862949923, 1.993695976693135, -6.201288741415874]);
    ...
    perspectiveCamera1.p.t.set([9.224242698121234, 2.2423680601820535, -3.903239746540361]);
    perspectiveCamera1.p.r.set([-6.1759505372080765, 82.50985952051964, 6.123655143365411]);
...
//# sourceMappingURL=src_engine_examples_examples_sop_Copy_stairCaseMultiple_ts.7e7930bab0e8cbf13f38.js.map