(self["webpackChunk"] = self["webpackChunk"] || []).push([["src_engine_examples_examples_actor_SetObjectLookAt_camera_ts"],{
  ...
  function create_objects(parentNode) {
    ...
    function create_actor1(objects2) {
      ...
      function create_getObject1(actor12) {
        ...
        getObject1.uiData.setPosition(-100, 300);
        getObject1.p.getCurrentObject.set(false);
        getObject1.p.mask.set(" /perspectiveCamera1");
      ...
      function create_getObjectProperty1(actor12) {
        var getObjectProperty1 = actor12.createNode("getObjectProperty");
        getObjectProperty1.setName("getObjectProperty1");
        const getObjectProperty1_nodes = {};
        getObjectProperty1.uiData.setPosition(100, 300);
      ...
      actor1_nodes["getObjectProperty1"] = create_getObjectProperty1(actor1);
      actor1_nodes["onTick1"] = create_onTick1(actor1);
      actor1_nodes["setObjectLookAt1"] = create_setObjectLookAt1(actor1);
      actor1_nodes["getObjectProperty1"].node.setInput("Object3D", actor1_nodes["getObject1"].node, "Object3D");
      ...
      actor1_nodes["setObjectLookAt1"].node.setInput(
        "targetPosition",
        actor1_nodes["getObjectProperty1"].node,
        "position"
      );
...
//# sourceMappingURL=src_engine_examples_examples_actor_SetObjectLookAt_camera_ts.78cdc996a1fb971c6d39.js.map