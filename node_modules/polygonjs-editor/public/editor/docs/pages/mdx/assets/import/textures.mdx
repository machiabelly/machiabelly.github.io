...
And just like [importing models](/docs/assets/import/models) from a url, importing textures from a remote url isn't the most convenient. This is where the [local version](/install) can also help you.
...
Let's have a look at <DocRouterLink bang href="/docs/assets/export!" innerText="the file types you can export &rarr;"></DocRouterLink>
