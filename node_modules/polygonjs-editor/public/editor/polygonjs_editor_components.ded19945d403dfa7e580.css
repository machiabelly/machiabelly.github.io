...
@font-face {
	font-family: "codicon";
	font-display: block;
	src: url(/editor/e053fabf5e3a25640d55.ttf) format("truetype");
}
 ...
 */
@-webkit-keyframes progress { from { transform: translateX(0%) scaleX(1) } 50% { transform: translateX(2500%) scaleX(3) } to { transform: translateX(4900%) scaleX(1) } }
...
/*# sourceMappingURL=polygonjs_editor_components.ded19945d403dfa7e580.css.map*/