import {
  EXTENSIONS_BY_NODE_TYPE_BY_CONTEXT
} from "./chunk-HNBBUMSC.js";
import {
  TypedSopNode
...
// node_modules/@polygonjs/polygonjs/dist/src/core/loader/_Base.js
...
var LOADING_MANAGER = createLoadingManager();
var _CoreBaseLoader = class {
  // not static
...
var CoreBaseLoader = _CoreBaseLoader;
CoreBaseLoader.loadingManager = LOADING_MANAGER;

// node_modules/@polygonjs/polygonjs/dist/src/core/loader/font/Font.js
var Font = class {
  constructor(data) {
    this.data = data;
    this.isFont = true;
...
// node_modules/@polygonjs/polygonjs/dist/src/core/loader/font/FontLoader.js
...
// node_modules/@polygonjs/polygonjs/node_modules/three/examples/jsm/loaders/SVGLoader.js
...
// node_modules/@polygonjs/polygonjs/node_modules/three/examples/jsm/libs/opentype.module.js
...
// node_modules/@polygonjs/polygonjs/node_modules/three/examples/jsm/loaders/TTFLoader.js
...
// node_modules/@polygonjs/polygonjs/dist/src/core/loader/font/CoreFontLoader.js
var FileFontFormat = ((FileFontFormat2) => {
  FileFontFormat2["JSON"] = "json";
  FileFontFormat2["TTF"] = "ttf";
  return FileFontFormat2;
})(FileFontFormat || {});
var CoreLoaderFont = class extends CoreBaseLoader {
...
// node_modules/@polygonjs/polygonjs/dist/src/core/Assets.js
var DEMO_ASSETS_ROOT_URL = "https://raw.githubusercontent.com/polygonjs/polygonjs-assets/master";
var DEFAULT_FONT_URL_JSON = `${DEMO_ASSETS_ROOT_URL}/fonts/droid_sans_regular.typeface.json`;
var DEFAULT_FONT_URL_TTF = `${DEMO_ASSETS_ROOT_URL}/fonts/SourceCodePro-BoldIt.ttf`;

// node_modules/@polygonjs/polygonjs/dist/src/core/geometry/text/TextJustify.js
var TextSopJustifiyMode = ((TextSopJustifiyMode2) => {
...
var TEXT_SOP_JUSTIFY_MODES = [
  "left",
  "right",
  "center"
  /* CENTER */
];
function applyJustifyModeToGeometries(geometries, params) {
...
// node_modules/@polygonjs/polygonjs/dist/src/core/geometry/text/TextMesh.js
function createGeometriesFromTypeMesh(params) {
  var _a;
...
// node_modules/@polygonjs/polygonjs/dist/src/core/geometry/text/TextShapes.js
function getShapes(params) {
  return params.font.generateShapes(params.text, params);
}

// node_modules/@polygonjs/polygonjs/dist/src/core/geometry/text/TextFlat.js
function createGeometriesFromTypeFlat(params) {
  var _a;
  return (_a = params.shapes) == null ? void 0 : _a.map((shapes) => createGeometryFromTypeFlat({ shapes }));
}
function createGeometryFromTypeFlat(params) {
  var _a;
  const geometries = ((_a = params.shapes) == null ? void 0 : _a.map((s) => new ShapeGeometry(s))) || [];
  if (geometries == null || geometries.length == 0) {
    return;
  }
  return mergeGeometries(geometries);
...
// node_modules/@polygonjs/polygonjs/dist/src/core/geometry/text/TextStroke.js
async function createGeometriesFromTypeStroke(params) {
  var _a;
...
// node_modules/@polygonjs/polygonjs/dist/src/core/geometry/text/TextShapesFromFont.js
function shapesFromFont(shapes) {
  return shapes == null ? void 0 : shapes.map((shapes2) => _shapesForLetter(shapes2));
}
function _shapesForLetter(shapes) {
...
// node_modules/@polygonjs/polygonjs/dist/src/core/geometry/text/TextLine.js
function createGeometriesFromTypeLine(params) {
  var _a;
...
// node_modules/@polygonjs/polygonjs/dist/src/core/geometry/text/TextType.js
var TextType = ((TextType2) => {
  TextType2["MESH"] = "mesh";
  TextType2["FLAT"] = "flat";
  TextType2["LINE"] = "line";
  TextType2["STROKE"] = "stroke";
  return TextType2;
})(TextType || {});
var TEXT_TYPES = [
  "mesh",
...
// node_modules/@polygonjs/polygonjs/dist/src/core/geometry/text/TextGeometries.js
async function textBuildGeometries(params) {
...
// node_modules/@polygonjs/polygonjs/dist/src/engine/operations/sop/TransformReset.js
var TransformResetMode = ((TransformResetMode2) => {
...
var TRANSFORM_RESET_MODES = [
  "reset objects transform",
  "center geometries",
  "center geometry and reset object"
  /* CENTER_GEO_RESET_OBJECT */
];
var bboxCenter = new Vector3();
var translateMatrix = new Matrix4();
var _TransformResetSopOperation = class extends BaseSopOperation {
  static type() {
...
var TransformResetSopOperation = _TransformResetSopOperation;
TransformResetSopOperation.DEFAULT_PARAMS = {
  mode: 0
};
TransformResetSopOperation.INPUT_CLONED_STATE = InputCloneMode.FROM_NODE;

// node_modules/@polygonjs/polygonjs/dist/src/core/geometry/text/TextLineHeight.js
function applyTextLineHeight(geometries, params) {
  if (geometries.length == 0) {
    return;
  }
...
// node_modules/@polygonjs/polygonjs/dist/src/core/geometry/text/TextMergeLetters.js
function textMergeLetters(params) {
...
// node_modules/@polygonjs/polygonjs/dist/src/engine/nodes/sop/Text.js
var GENERATION_ERROR_MESSAGE = `failed to generate geometry. Try to remove some characters`;
var TextSopParamsConfig = class extends NodeParamsConfig {
  constructor() {
    super(...arguments);
...
var ParamsConfig = new TextSopParamsConfig();
var TextSopNode = class extends TypedSopNode {
  constructor() {
    super(...arguments);
...
*/
//# sourceMappingURL=@polygonjs_polygonjs_dist_src_engine_nodes_sop_Text.js.map
